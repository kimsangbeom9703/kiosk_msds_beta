...
function setInit() {
    ...
    setLoadLanguage('/a/include/kiosk_lang.json');
    setNoticeDrawInfo();
...
function setWeather(_json) {
    ...
    let t_url = '/a/images/weather/DB01_B.svg';
    if (_json.sky == '1') {
        //맑음
        if (parseInt(rour) > 18 || parseInt(rour) < 6) {
            t_url = '/a/images/weather/DB01_N_B.svg';
        } else {
            t_url = '/a/images/weather/DB01_B.svg';
        }
    } else if (_json.sky == '2') {
        //구름많음
        if (parseInt(rour) > 18 || parseInt(rour) < 6) {
            t_url = '/a/images/weather/DB03_N_B.svg';
        } else {
            t_url = '/a/images/weather/DB03_B.svg';
        }
    } else if (_json.sky == '3') {
        //흐림
        t_url = '/a/images/weather/DB04_B.svg';
    } else if (_json.sky == '4') {
        //비
        t_url = '/a/images/weather/DB05_B.svg';
    } else if (_json.sky == '4') {
        //비/눈
        t_url = '/a/images/weather/DB06_N_B.svg';
    } else if (_json.sky == '4') {
        //눈
        t_url = '/a/images/weather/DB08_B.svg';
    } else if (_json.sky == '4') {
        //소나기
        t_url = '/a/images/weather/DB07_B.svg';
    }
...
function setLoadPdf(_url) {
    ...
    pdfjsLib.GlobalWorkerOptions.workerSrc = '/a/include/js/lib/pdf.worker.js';

    let loadingTask = pdfjsLib.getDocument({
        url: url,
        cMapUrl: '/a/include/js/lib/cmaps/',
